...
class Board(object):
	...
	def game_over_animation(self, win):
		...
		while time_elapsed < animation_time:
			...
			self.draw()
			overlay = pygame.Surface((self.scr_size[0], self.scr_size[1]), pygame.SRCALPHA)
		...
		self.surface.blit(game_over_rect_rounded, (self.scr_size[0]/2-150,self.scr_size[1]/2-75))
